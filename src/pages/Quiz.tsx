...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-900 to-black flex flex-col items-center justify-center text-white px-4 py-8">
      <img src={logohp} alt="Harry Potter Logo" className="w-32 sm:w-48 mb-8 animate-bounce" />
      ...
      <form onSubmit={handleStart} className="flex flex-col items-center gap-4 w-full max-w-sm">
        <p className="text-lg text-center">Digite seu nome para iniciar</p>
        ...
        <input
          ...
          className="w-full px-4 py-2 rounded-xl text-black text-center bg-amber-50"
        />
